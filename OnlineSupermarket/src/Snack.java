...
public class Snack extends Food {
    ...
    public Snack(double calorie, String name, String packageType, double quantity, double price) {
        super(calorie, name, packageType, quantity, price);
    }
    
    public Snack(String name,Double price,int numberOfProduct){
    ...
    public static ListOperations snackList = new ListOperations();
    public static ArrayList<String> firstNames = new ArrayList<String>();
    
    public static void readFromFile() throws FileNotFoundException {
       
        File file = new File("snack.txt");
        ...
        while(input.hasNext()){
            ...
            Snack snack = new Snack(calorie, name, packageType, quantity, price);
            
            snackList.addObject(snack);
        }
    }
